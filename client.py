...
class Client:
    ...
    def order_book(self, symbol, parameters=None):
        ...
        Optional parameters
        limit_bids (int): Optional. Limit the number of bids returned. May be 0 in which case the array of bids is empty. Default is 50.    買
        limit_asks (int): Optional. Limit the number of asks returned. May be 0 in which case the array of asks is empty. Default is 50.    賣
        eg.
        ...
        try:
            ...
            print 'Error while catching order_book ',inst
            time.sleep(5)
            return self.order_book(symbol, parameters)
